...
#[QueryParameter(key: 'order', schema: ['type' => 'object'], description: 'API Platform-style ordering for member-presence-stats, e.g. order[presenceCount]=DESC. Allowed fields: presenceCount, lastPresenceDate, medicalCertificateExpiration, lastControlShooting.', required: false)]
