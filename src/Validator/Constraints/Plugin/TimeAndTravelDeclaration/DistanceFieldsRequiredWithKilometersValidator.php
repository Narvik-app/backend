 ...
 */
final class DistanceFieldsRequiredWithKilometersValidator extends AbstractDeclarationValidator {
  protected function assertConstraintType(Constraint $constraint): void {
    if (!$constraint instanceof DistanceFieldsRequiredWithKilometers) {
      throw new UnexpectedTypeException($constraint, DistanceFieldsRequiredWithKilometers::class);
    }
  }
