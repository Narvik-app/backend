...
final class EditableTodayValidator extends ConstraintValidator {
  ...
  public function validate(mixed $value, Constraint $constraint): void {
    if (!$constraint instanceof EditableToday) {
      throw new UnexpectedTypeException($constraint, EditableToday::class);
    }
