...
final class BackdateAllowedValidator extends ConstraintValidator {
  ...
  public function validate(mixed $value, Constraint $constraint): void {
    if (!$constraint instanceof BackdateAllowed) {
      throw new UnexpectedTypeException($constraint, BackdateAllowed::class);
    }
