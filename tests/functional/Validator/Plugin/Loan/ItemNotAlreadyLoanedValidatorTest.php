...
namespace App\Tests\functional\Validator\Plugin\Loan;
...
class ItemNotAlreadyLoanedValidatorTest extends AbstractTestCase {
  ...
  public function testNewLoanForFreeItemIsValid(): void {
    ...
    $violations = $this->validator->validate($loan, new ItemNotAlreadyLoaned());
