 ...
 */
final class Version20260105172938 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add PermissionTemplate entity and update MemberPermission with template support';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE member_permission (permission VARCHAR(255) NOT NULL, id INT NOT NULL, uuid UUID NOT NULL, member_id INT DEFAULT NULL, template_id INT DEFAULT NULL, PRIMARY KEY (id))');
