...
1. If not already done, [install Docker Compose](https://docs.docker.com/compose/install/) (v2.10+) or [Podman](https://podman.io/getting-started/installation) with `podman compose`
